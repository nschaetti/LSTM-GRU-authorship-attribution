    ...
    for n in range(args.n_samples):
        ...
        for k in range(args.fold, 5):
            ...
            for epoch in range(args.epoch):
                ...
                # Max. threshold
                max_validation_threshold = thresholds[torch.argmax(validation_f1_score).item()]

                # Keep best model
                if max_validation_f1 > best_f1:
                    add_str = "##"
                    best_f1 = max_validation_f1
                    best_threshold = max_validation_threshold.item()
                    torch.save(
                        rnn.state_dict(),
                ...
                # Show loss
                print("epoch {}, training loss {} ({}), training average F1 {}, validation loss {} ({}), validation average F1 {} (threshold {}) {}".format(
                    epoch,
                    ...
                    round(max_validation_threshold.item(), 2),
                    add_str
                ))
            # end for
            ...
            print("Test loss {}, F1-score {} (threshold {})".format(
                ...
                round(test_f1_score, 5),
                round(best_threshold, 2)
            ))

            # Print success rate
            xp.add_result(test_f1_score)
