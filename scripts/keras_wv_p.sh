...
python model_rnn_keras.py --hidden-size 1000 --cell-size 1000 --embedding-size 300 --feature wv --learning-window 40 --max-length 40 --n-authors 50 --output outputs/ --name "AA Na50 LSTM 1000-1000 WV-P keras" --description "Authorship Attribution 50 authors LSTM 1000 hidden neurons, Word Vectors (WV) pretrained with Glove" --rnn-type LSTM --epoch 250 --pretrained --verbose 4
