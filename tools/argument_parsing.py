...
def parser_training():
    ...
    args.add_argument(command="--fold", name="fold", type=int, help="Initial fold", extended=False, default=0)
    ...
    args.add_argument(command="--zero-weight", name="zero_weight", type=float, help="Weight given to zeros (SFGram)",
                      default=1, required=False, extended=False)
    ...
    args.add_argument(command="--xpname", name="xpname", type=str, help="Experiment's name", extended=False, required=True)
